...
define(function (){
     ...
     * @returns {Array2D}
     */
    exports.Float2D = function (input) {
        "use strict";
    ...
    exports.Cellblock2D = function (input) {
        ...
        var hidden_fields = exports.List1D({
            newObject: function() {
                return exports.Float2D({
                    num_i: num_cells_i,
                    num_j: num_cells_j
                });
            },
